...
namespace FastyBird\Connector\Tuya\Hydrators\Channels;
...
final class Channel extends DevicesHydrators\Channels\Channel
{
	...
	): Entities\Devices\Device
	{
		...
		throw new JsonApiExceptions\JsonApiError(
			...
			strval($this->translator->translate('//tuya-connector.base.messages.invalidRelation.heading')),
			strval($this->translator->translate('//tuya-connector.base.messages.invalidRelation.message')),
			[
