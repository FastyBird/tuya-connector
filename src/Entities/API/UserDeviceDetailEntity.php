 ...
 * @author         Adam Kadlec <adam.kadlec@fastybird.com>
 */
final class UserDeviceDetailEntity implements IEntity
{
	 ...
	 * @param bool $online
	 * @param UserDeviceStatusEntity[] $status
	...
	public function toArray(): array
	{
		return [
			...
			'status'       => array_map(function (UserDeviceStatusEntity $item): array {
				return $item->toArray();
			}, $this->getStatus()),
